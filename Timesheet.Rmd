...
# Grant Agreement {.tabset}

### Gantt of the Project

```{r Gantt, include=TRUE, fig.retina=3, out.width='90%'}
...
### Sincro Initial according Grant Agreement (G.A)
...
### Implication Personnel UL : Janvier 2020 - `r format(Sys.time(), "%b %d %Y")`
